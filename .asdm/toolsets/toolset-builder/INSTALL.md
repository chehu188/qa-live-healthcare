...
cat > .claude/commands/asdm-generate-install.md << 'EOF'
---
description: "Generate installation guide for toolset"
argument-hint: "[toolset-id]"
---

EOF
cat .asdm/toolsets/toolset-builder/actions/asdm-generate-install.md >> .claude/commands/asdm-generate-install.md

# Complete toolset command
cat > .claude/commands/asdm-complete-toolset.md << 'EOF'
---
description: "Complete and finalize the toolset"
argument-hint: "[toolset-id]"
---
...
cat > .github/prompts/asdm-generate-install.prompt.md << 'EOF'
---
agent: 'agent'
description: 'Generate installation guide for toolset'
argument-hint: 'Enter toolset ID'
...
EOF
cat .asdm/toolsets/toolset-builder/actions/asdm-generate-install.md >> .github/prompts/asdm-generate-install.prompt.md
...
cp .asdm/toolsets/toolset-builder/actions/asdm-generate-install.md .codebuddy/commands/
...
2. **Right-click on the desired instruction file** and copy its relative path:
   ...
   - For generating install: `asdm-generate-install.md`
...
```shell
Follow the instructions in .asdm/toolsets/toolset-builder/actions/asdm-generate-install.md
```

This will:
1. Generate comprehensive INSTALL.md
2. Include installation steps for all supported providers
3. Add workspace structure and usage examples
...
2. Check completeness and consistency
3. Generate a summary of the toolset
...
4. **`/asdm-generate-install`** - Generate installation guide
5. **`/asdm-complete-toolset`** - Complete and finalize the toolset
...
│   ├── asdm-generate-install.md      ## Generate installation guide
│   └── asdm-complete-toolset.md     ## Complete and finalize
...
- `.asdm/toolsets/toolset-builder/actions/asdm-generate-install.md`
...
# Step 4: Generate installation guide
/asdm-generate-install my-toolset
