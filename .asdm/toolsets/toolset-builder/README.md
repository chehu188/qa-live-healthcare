...
### Generate Installation Guide (generate-install)

Generate installation instructions for the new toolset:
- Detect supported AI providers
- Create installation commands for each provider
- Include workspace structure setup
- Add usage examples

Output: INSTALL.md with complete installation instructions
...
Output: Complete, ready-to-use toolset
...
- `/asdm-generate-install`: Generate installation guide
- `/asdm-complete-toolset`: Finalize and review the toolset
...
Use `/asdm-generate-install` to create the installation instructions for the new toolset.

### Step 5: Complete and Review
Use `/asdm-complete-toolset` to finalize the toolset, validate all files, and get a summary.
